...
- **Reduce resource requests for the containers.**
  ...
  - You can specify more specific value for each containers. Refer [official documentation](https://github.com/ansible/awx-operator/blob/1.1.2/README.md#containers-resource-requirements) for details.
